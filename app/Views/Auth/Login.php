                        ...
                        <div class="col-lg-5">
                            <form action="/auth-login" method="POST">
                                <div class="form-floating mb-3">
                                    <input class="shadow bg-body rounded form-control rounded-pill" type="email" name="Email" placeholder="name@example.com">
                                    <label for="inputEmail">E-mail Address</label>
                                </div>
                                <div class="form-floating mb-5">
                                    <input class="shadow bg-body rounded form-control rounded-pill" type="password" name="Password" placeholder="Password">
